            ...
            html: `
                ...
                <head>
                    ...
                    <style>
                        ...
                        .content { padding: 20px; text-align: center; color: #555555; }
                        .otp-code { display: inline-block; background-color: #e0f7fa; color: #006064; font-size: 32px; font-weight: bold; padding: 15px 30px; border-radius: 5px; letter-spacing: 5px; margin: 20px 0; border: 1px dashed #0097a7; }
